...
export const CandidateCard: React.FC<CandidateCardProps> = ({ candidate }) => {
  ...
  return (
    <div className="bg-white border-b border-gray-200 py-3 px-3 sm:py-4 sm:px-4 md:py-4 md:px-4 hover:bg-gray-50 transition-colors">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
        {/* Name Column */}
        <div className="flex flex-col">
          <a
            href="#"
            className="text-sm sm:text-base font-medium text-blue-600 hover:text-blue-800 mb-1 cursor-pointer transition-colors"
          >
            {candidate.name}
          </a>
          ...
          {!candidate?.has_interviews && (
            <>
              <div className="text-xs sm:text-sm mt-3 sm:mt-4 sm:-ml-1">
                <button className="text-[#00A88F] hover:text-[#008f7a] hover:underline font-medium cursor-pointer transition-colors">
        ...
        {candidate?.availability_status === 'Not Requested' && (
          <div className="mt-4 sm:mt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button className="pointer-events-auto text-sm sm:text-base text-[#00A88F] hover:text-[#008f7a] font-normal transition-colors">
                Not Requested
              </button>
            </div>
            <button className="cursor-pointer pointer-events-auto text-sm sm:text-base text-[#00A88F] hover:text-[#008f7a] hover:underline font-normal transition-colors">
            ...
            <div className="mt-4 sm:mt-6 w-full pr-0 sm:pr-4 md:pr-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-3 w-full gap-2 sm:gap-0">
                ...
                <div className="flex flex-wrap items-center gap-1 sm:gap-2 sm:ml-2 bo">
                  <button className="text-md text-[#00A88F] hover:text-[#008f7a] hover:underline font-normal cursor-pointer transition-colors whitespace-nowrap">
              ...
              {/* Individual Interview List - Indented */}
                ...
                {candidate?.interviews.map((interview, index) => (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap items-center gap-1 sm:gap-2">
                      ...
                      <span className="text-gray-400">|</span>
                      <button className="cursor-pointer text-black hover:text-gray-700 transition-colors">
